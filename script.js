...
const sunoTracks = [
    ...
    { "id": "423d3dea-7a36-4621-a3b2-ff92edc066d4", "title": "Bossa Jazz A Cappella", "artist": "3Daizy🌼", "category": "Calme Puissant", "duration": 140 },
...
// Variables globales
let currentCategory = "decollage-express"; // Catégorie par défaut
...
function getTracksByCategory(category) {
    return sunoTracks.filter(track => track.category.toLowerCase().replace(/ /g, '-') === category);
}
...
function selectRandomTrack() {
    ...
    if (availableTracks.length === 0) {
        console.warn(`Aucun morceau pour ${currentCategory}.`);
